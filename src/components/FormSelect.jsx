...
// const FormSelect = ({ name, value, options, onChange, bdr, padds,errorMessage }) => {
//   const [isFocused, setIsFocused] = useState(false);
//   const styleS = {
//     border: bdr,
//     padding: padds,
//     borderColor: isFocused ? '#ccc' : (errorMessage ? '#ff8080' : '#ccc'), // Light red border on error
//     boxShadow: isFocused ? '0 0 5px #ccc': (errorMessage ? '0 0 5px #ff4d4d' : '0 0 5px rgba(0, 0, 0, 0.1)'), // Light red shadow on error
//     borderWidth: '2px',
//     borderStyle: 'solid',
//     outline: 'none',
//   };
